...
try {
    ...
    $stmtLogin = $conn->prepare("INSERT INTO login (MemberID, UserName, Password) VALUES (?, ?, ?)");

    $stmtLogin->bind_param("sss", $lastInsertedID, $MuserName, $hashedPassword);
    ...
    // Insert Payment
    $stmtPayment = $conn->prepare("INSERT INTO payment (MemberID, PaymentDate, PaymentAmount, PaymentMode) 
                       VALUES (?, NOW(), ?, 'cash')");
